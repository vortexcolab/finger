...
var fingerprint = function() {
    function murmurhash3_32_gc(key, seed) {
        ...
        var i = 0;
        while (i < bytes) {
            var k1_1 = key.charCodeAt(i) & 255 | (key.charCodeAt(++i) & 255) << 8 | (key.charCodeAt(++i) & 255) << 16 | (key.charCodeAt(++i) & 255) << 24;
            ++i;
            k1_1 = (k1_1 & 65535) * c1 + (((k1_1 >>> 16) * c1 & 65535) << 16) & 4294967295;
            k1_1 = k1_1 << 15 | k1_1 >>> 17;
            k1_1 = (k1_1 & 65535) * c2 + (((k1_1 >>> 16) * c2 & 65535) << 16) & 4294967295;
            h1 ^= k1_1;
            h1 = h1 << 13 | h1 >>> 19;
    ...
    return new Promise(function(resolve, reject) {
        var fingerprints = {
            ...
            browserObjects: function() {
                return new Promise(function(resolve) {
                    var foundObjects = [];
                    var objects = ["chrome", "safari", "__crWeb", "__gCrWeb", "yandex", "__yb", "__ybro", "__firefox__", "__edgeTrackingPreventionStatistics", "webkit", "oprt", "samsungAr", "ucweb", "UCShellJava", "puffinDevice", "opr"];
            ...
            math: function() {
                return new Promise(function(resolve) {
                    ...
                    var e = 1e154;
                    var fp = [(m.acos || returnZero)(.12312423423423424), (m.acosh || returnZero)(1e308), m.log(e + m.sqrt(e * e - 1)), (m.asin || returnZero)(.12312423423423424), (m.asinh || returnZero)(1), m.log(m.sqrt(2) + 1), (m.atanh || returnZero)(.5), m.log(3) / 2, (m.atan || returnZero)(.5), (m.sin || returnZero)(-1e300), (m.sinh || returnZero)(1), m.exp(1) - 1 / m.exp(1) / 2, (m.cos || returnZero)(10.000000000123), (m.cosh || returnZero)(1), (m.exp(1) + 1 / m.exp(1)) / 2, (m.tan || returnZero)(-1e300), (m.tanh || returnZero)(1), (m.exp(2) - 1) / (m.exp(2) + 1), (m.exp || returnZero)(1), (m.expm1 || returnZero)(1), m.exp(1) - 1, (m.log1p || returnZero)(10), m.log(11), m.pow(m.PI, -100)];
        ...
        Promise.all(promises).then(function(k) {
            ...
            var persistentFpComponetents = [profile.jsHeapSizeLimit, profile.audioContext, profile.canvasAPI, profile.performance, profile.speechSynthesis, profile.webglInfo, profile.webglProgram];
