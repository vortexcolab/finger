...
var FingerprintJS = function(e) {
    ...
    function v() {
        var e = window
          , t = navigator;
        return h(["MSCSSMatrix"in e, "msSetImmediate"in e, "msIndexedDB"in e, "msMaxTouchPoints"in t, "msPointerEnabled"in t]) >= 4
    }
    function g() {
        var e = window
          , t = navigator;
        return h(["msWriteProfilerMark"in e, "MSStream"in e, "msLaunchUri"in t, "msSaveBlob"in t]) >= 3 && !v()
    }
    function m() {
        var e = window
          , t = navigator;
        return h(["webkitPersistentStorage"in t, "webkitTemporaryStorage"in t, 0 === t.vendor.indexOf("Google"), "webkitResolveLocalFileSystemURL"in e, "BatteryManager"in e, "webkitMediaStream"in e, "webkitSpeechGrammar"in e]) >= 5
    }
    function p() {
        var e = window
          , t = navigator;
        return h(["ApplePayError"in e, "CSSPrimitiveValue"in e, "Counter"in e, 0 === t.vendor.indexOf("Apple"), "getStorageUpdates"in t, "WebKitMediaKeys"in e]) >= 4
    }
    function w() {
        var e = window;
        return h(["safari"in e, !("DeviceMotionEvent"in e), !("ongestureend"in e), !("standalone"in navigator)]) >= 3
    }
    function y(e, t, n) {
        (function(e) {
        ...
        return new Promise((function(t, n) {
            ...
            var r = 3
              , o = function() {
                ...
                case "suspended":
                    document.hidden || r--,
                    r > 0 ? setTimeout(o, 500) : n(C("suspended"))
                }
            };
            o()
        }
    ...
    var x = {
        ...
        languages: function() {
            ...
            Array.isArray(t.languages))
                m() && h([!("MediaSettingsRange"in (e = window)), "RTCEncodedAudioFrame"in e, "" + e.Intl == "[object Intl]", "" + e.Reflect == "[object Reflect]"]) >= 3 || n.push(t.languages);
        ...
        deviceMemory: function() {
            return e = d(navigator.deviceMemory),
            t = void 0,
        ...
        availableScreenResolution: function() {
            ...
            if (e.availWidth && e.availHeight) {
                var t = [f(e.availWidth), f(e.availHeight)];
                return t.sort().reverse(),
                t
            }
        },
        ...
        fonts: function() {
            var e = document
              ...
              , c = function(e) {
                return A.some((function(t, n) {
                    return e[n].offsetWidth !== o[t] || e[n].offsetHeight !== i[t]
                }
                ))
            }
              , u = A.map((function(e) {
                var t = a();
                return t.style.fontFamily = e,
                n.appendChild(t),
                t
            }
            ));
            ...
            for (var s = 0, l = A.length; s < l; s++)
                o[A[s]] = u[s].offsetWidth,
                i[A[s]] = u[s].offsetHeight;
            var f = function() {
                ...
                }, n = 0, o = M; n < o.length; n++) {
                    t(o[n])
                }
                return e
            }();
            t.appendChild(r);
            for (var d = [], h = 0, v = M.length; h < v; h++)
                c(f[M[h]]) && d.push(M[h]);
            ...
            return s(this, void 0, void 0, (function() {
                ...
                return l(this, (function(c) {
                    ...
                    case 0:
                        ...
                        if (p() && !w() && !function() {
                            var e = window;
                            return h(["DOMRectList"in e, "RTCPeerConnectionIceEvent"in e, "SVGGeometryElement"in e, "ontransitioncancel"in e]) >= 3
                        }())
                            return [2, -1];
                    ...
                    case 2:
                        ...
                        [3, 5];
                    case 3:
                        if ("timeout" === (a = c.sent()).name || "suspended" === a.name)
                            return [2, -3];
                        throw a;
                    case 4:
                        return r.disconnect(),
                    ...
                    case 1:
                        ...
                        n = function(e) {
                            ...
                            return {
                                components: e,
                                get visitorId() {
                                    return void 0 === t && (t = I(this.components)),
                                    t
                                },
                                set visitorId(e) {
                                    t = e
    ...
    var R = {
        load: D,
        hashComponents: I,
        componentsToDebugString: O
    }
      , B = c;
    return e.componentsToDebugString = O,
    e.default = R,
    e.getComponents = P,
    e.hashComponents = I,
    e.isChromium = m,
    ...
    e.isGecko = function() {
        var e, t, n = window;
        return h(["buildID"in navigator, "MozAppearance"in (null !== (t = null === (e = document.documentElement) || void 0 === e ? void 0 : e.style) && void 0 !== t ? t : {}), "MediaRecorderErrorEvent"in n, "mozInnerScreenX"in n, "CSSMozDocumentRule"in n, "CanvasCaptureMediaStream"in n]) >= 4
    }
    ,
    e.isTrident = v,
    e.isWebKit = p,
    e.load = D,
    e.murmurX64Hash128 = B,
    e
}({});