    ...
    return e.prototype = {
        ...
        jsFontsKey: function(e, t) {
            ...
            return setTimeout(function() {
                ...
                s.style.fontSize = r, s.innerHTML = n;
                var l = {},
                    h = {};
        ...
        getHasLiedOs: function() {
            ...
            var n;
            if (n = "ontouchstart" in window || navigator.maxTouchPoints > 0 || navigator.msMaxTouchPoints > 0, n && "Windows Phone" !== e && "Android" !== e && "iOS" !== e && "Other" !== e) return !0;
        ...
        loadSwfAndDetectFonts: function(e) {
            ...
            swfobject.embedSWF(this.options.swfPath, i, "1", "1", "9.0.0", !1, a, n, {})
        },
        ...
        x64hash128: function(e, t) {
            e = e || "", t = t || 0;
            for (var i = e.length % 16, a = e.length - i, n = [0, t], r = [0, t], o = [0, 0], s = [0, 0], l = [2277735313, 289559509], h = [1291169091, 658871167], u = 0; a > u; u += 16) o = [255 & e.charCodeAt(u + 4) | (255 & e.charCodeAt(u + 5)) << 8 | (255 & e.charCodeAt(u + 6)) << 16 | (255 & e.charCodeAt(u + 7)) << 24, 255 & e.charCodeAt(u) | (255 & e.charCodeAt(u + 1)) << 8 | (255 & e.charCodeAt(u + 2)) << 16 | (255 & e.charCodeAt(u + 3)) << 24], s = [255 & e.charCodeAt(u + 12) | (255 & e.charCodeAt(u + 13)) << 8 | (255 & e.charCodeAt(u + 14)) << 16 | (255 & e.charCodeAt(u + 15)) << 24, 255 & e.charCodeAt(u + 8) | (255 & e.charCodeAt(u + 9)) << 8 | (255 & e.charCodeAt(u + 10)) << 16 | (255 & e.charCodeAt(u + 11)) << 24], o = this.x64Multiply(o, l), o = this.x64Rotl(o, 31), o = this.x64Multiply(o, h), n = this.x64Xor(n, o), n = this.x64Rotl(n, 27), n = this.x64Add(n, r), n = this.x64Add(this.x64Multiply(n, [0, 5]), [0, 1390208809]), s = this.x64Multiply(s, h), s = this.x64Rotl(s, 33), s = this.x64Multiply(s, l), r = this.x64Xor(r, s), r = this.x64Rotl(r, 31),
                r = this.x64Add(r, n), r = this.x64Add(this.x64Multiply(r, [0, 5]), [0, 944331445]);
...
! function(e, t, r) {
    ...
    function keysOf(e) {
        ...
        Object && (Object.getOwnPropertyNames && Object.getOwnPropertyNames(e).forEach(r), Object.keys && Object.keys(e).forEach(r));
        for (var n in e) r(n);
        return t
    }
    ...
    function membersOf(e) {
        var t = {
            ...
            r = function(e) {
                return e.length > 1 && e.charAt(0) == e.charAt(0).toUpperCase() && isNaN(parseInt(e.charAt(0), 10))
            };
        return keysOf(e).forEach(function(n) {
            var i = e[n];
            "function" == typeof i && isNative(i) && (r(n) ? t.types.push(n) : t.functions.push(n))
        }), t.functions.sort(), t.types.sort(), t
    }

    function errorOf(e) {
        var t = "";
        return "string" == typeof e ? t = e : e.message && "string" == typeof e.message ? t = e.message : e.description && "string" == typeof e.description ? t = e.description : e.toString && "function" == typeof e.toString && (t = e.toString()), t
    }
    ...
    function stringifyObject(e) {
        return keysOf(e).map(function(t) {
            return t + "=" + e[t]
        }).join(";")
    }

    function stringifyMembers(e) {
        return stringifyArray(e.types) + ";" + stringifyArray(e.functions)
    }

    function snakeToPascal(e) {
        return e.split("_").map(function(e) {
            return e.length < 2 ? e.charAt(0).toUpperCase() : e.charAt(0).toUpperCase() + e.substring(1).toLowerCase()
        }).join("")
    }
    Array.prototype.forEach || (Array.prototype.forEach = function(e) {
        for (var t = 0; t < this.length; ++t) e(this[t])
    }), Array.prototype.map || (Array.prototype.map = function(e) {
        for (var t = [], r = 0; r < this.length; ++r) t[r] = e(this[r]);
        return t
    }), Array.prototype.filter || (Array.prototype.filter = function(e) {
        for (var t = [], r = 0; r < this.length; ++r) e(this[r]) && (t[r] = this[r]);
        return t
    ...
    var isNative = function() {
            var e = Object.prototype.toString,
                ...
                n = RegExp("^" + String(e).replace(/[.*+?^${}()|[\]\/\\]/g, "\\$&").replace(/toString|(function).*?(?=\\\()| for .+?(?=\\\])/g, "$1.*?") + "$");
            return function(i) {
                var o = typeof i;
                return "function" == o ? n.test(t.call(i)) : i && "object" == o && r.test(e.call(i)) || !1
            }
        }(),
        emptyDetection = {
            result: [],
        ...
        syncModules = [{
            ...
            detect: function(e) {
                ...
                return n.forEach(function(e) {
                    i(e) && r.push(e)
                }), window.GeckoActiveXObject && r.push("GeckoActiveX"), r.sort(), {
                    result: r,
                    raw: stringifyArray(r)
                }
            }
        }, {
            name: "ms_components",
            detect: function(e) {
                ...
                if (t.innerHTML = "<div style='behavior:url(#default#clientCaps)' ID='tempCompChecker' ></div>", document.body.appendChild(t), "undefined" == typeof tempCompChecker || "undefined" == typeof tempCompChecker.isComponentInstalled) return document.body.removeChild(t), emptyDetection;
                var r = [],
                    n = [
                    ...
                    i = function(e) {
                        return tempCompChecker.isComponentInstalled(e, "ComponentID")
                    };
                return n.forEach(function(e) {
                    i(e[1]) && r.push(e[0])
                }), document.body.removeChild(t), r.sort(), {
                    result: r,
                    raw: stringifyArray(r)
                }
            }
            ...
            name: "navigator_dump",
            detect: function(e) {
                if ("undefined" == typeof navigator) return emptyDetection;
                var t = membersOf(navigator);
                return {
                    result: t,
                    raw: stringifyMembers(t)
                }
            }
        }, {
            name: "toolbar_dump",
            detect: function(e) {
                if ("undefined" == typeof toolbar) return emptyDetection;
                var t = membersOf(toolbar);
                return {
                    result: t,
                    raw: stringifyMembers(t)
                }
            ...
            name: "crypto_dump",
            detect: function(e) {
                if ("undefined" == typeof crypto) return emptyDetection;
                var t = membersOf(crypto);
                return {
                    result: t,
                    raw: stringifyMembers(t)
                }
            ...
            name: "window_dump",
            detect: function(e) {
                if ("undefined" == typeof window) return emptyDetection;
                var t = membersOf(window);
                return {
                    result: t,
                    raw: stringifyMembers(t)
                }
            ...
            name: "document_dump",
            detect: function(e) {
                if ("undefined" == typeof document) return emptyDetection;
                var t = membersOf(document);
                return {
                    result: t,
                    raw: stringifyMembers(t)
                }
            ...
            detect: function(options) {
                var offendingFunctions = [function() {
                    ...
                    result = offendingFunctions.map(function(e) {
                        return diagnose(e)
                    });
                return {
                    result: result,
            ...
            detect: function(e) {
                ...
                if ("undefined" != typeof Silverlight) {
                    ...
                    t.installed = !!navigator.plugins["Silverlight Plug-In"]
                } catch (i) {}
                return {
                    result: t,
                    raw: stringifyObject(t)
        ...
        asyncModules = [{
            ...
            detect: function(e, t) {
                var r = 0,
                    n = [],
                    i = [".bmp", ".fli", ".gif", ".ico", ".jpg", ".mng", ".pbm", ".pcx", ".pgm", ".png", ".ppm", ".tga", ".tif", ".xbm"],
                    o = function() {
                        ++r == i.length && t({
                            result: n,
                            raw: stringifyArray(n)
                        })
                    };
                i.forEach(function(t) {
                    var r = document.createElement("img");
                    r.setAttribute("src", (e.imagesPath || "images/test") + t), r.onload = function() {
                        n.push(t), document.body.removeChild(r), o()
                    }, r.onerror = function() {
                        document.body.removeChild(r), o()
                    }, document.body.appendChild(r)
                })
            }
        }];
    return function(e) {
        var t = new Fingerprint2(e);
        this.get = function(r) {
            t.get(function(n, i) {
                var o = "";
                syncModules.filter(function(t) {
                    return !e["exclude" + snakeToPascal(t.name)]
                }).forEach(function(t) {
                    try {
                        var r = t.detect(e);
                        o += r.raw, i.push({
                ...
                var a = function() {
                        r(n + t.x64hash128(o, 31), i)
                    },
                    c = asyncModules.filter(function(t) {
                        return !e["exclude" + snakeToPascal(t.name)]
                    });
                if (0 == c.length) a();
                else {
