...
function computeCanvasFingerprint() {
  var canvas = document.getElementById('cfp');
  var ctx = canvas.getContext('2d');
  // Text with lowercase/uppercase/punctuation symbols
  var txt = "bot.incolumitas.com, <canvas> 1.0";
  ...
  var hash = b_crc32(data).toString(16).toUpperCase();
  document.getElementById('canvas_fingerprint').innerHTML = hash;
}
